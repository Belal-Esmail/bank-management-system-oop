...
private:
     ...
     string _PrepareLogInRecord(string Seperator = "#//#")
    {
        ...
        LoginRecord += UserName + Seperator;
	        //Never store passwords in the login activity log.
	        LoginRecord += "[HIDDEN]" + Seperator;
	     ...
	     static stLoginRegisterRecord _ConvertLoginRegisterLineToRecord(string Line, string Seperator = "#//#")
     {
         stLoginRegisterRecord LoginRegisterRecord;
	         ...
	         if (vLoginRegisterDataLine.size() != 4)
	         ...
	         try
	         {
	             ...
	             LoginRegisterRecord.Password = "[HIDDEN]";
...
public:
    enum enPermissions
    {
        eAll = -1, pListClients = 1, pAddNewClient = 2, pDeleteClient = 4 , pUpdaetClient = 8, pFindClient = 16,
